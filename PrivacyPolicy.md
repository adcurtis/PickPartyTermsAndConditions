...
- **Game Organizer data:** pool names, event titles, categories, and results you create when setting up a pool.
- **Player data:** picks and predictions you submit for any pool you join.
- **Display name:** your iCloud display name is used to identify you to other players in a pool.

### Information collected automatically
- **iCloud account identifier:** a system-generated identifier (not your email address) used to associate your picks and scores with your account. We never see your Apple ID or email address.
- **Participation amounts:** if a pool has an requested pledge amount, the amount you contributed is stored with your join record.
...
- **No data is stored on our servers.** We do not operate any backend infrastructure.

Apple's CloudKit Privacy Policy governs the storage and security of your data. See [apple.com/legal/privacy](https://www.apple.com/legal/privacy/).
...
- Purchases can be restored on any device signed in to the same Apple ID.
...
We may update this Privacy Policy periodically. We will notify users of material changes by updating the "Last updated" date above. Continued use of the App after changes constitutes acceptance of the updated policy.
...
**Digital Beach Software LLC**  
Email: admin@digitalbeachsoftware.com  
Support: admin@digitalbeachsoftware.com
